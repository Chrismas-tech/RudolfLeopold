...
@section('content')
    <main id="main" class="main tracks">
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <input type="text" name="album_name"
                                        class="form-control {{ $errors->has('album_name') ? 'my-is-invalid' : '' }}"
                                        value="{{ old('album_name') ?? old('album_name') }}">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="custom-file">
                                    <input type="file" id="mainImg" name="img_file"
                                        class="form-control  {{ $errors->has('main_image') ? 'my-is-invalid' : '' }}"
                                        accept="image/*">
                                </div>

                                <div class="div-img d-none text-center mt-4">
                                    <h3 id="title_preview_img"></h3>
                                    <img id="preview_main_image" class="img-fluid-main-variant" src=""
                                        alt="">
                                </div>
                            </div>

                            <div
                                class="form-group music-upload-admin {{ $errors->has('audio_files') ? 'my-is-invalid' : '' }}">
                                ...
                                <input type="file" name="audio_files[]"
                                    class="form-control multi_audio_files d-none {{ $errors->has('audio_files') ? 'my-is-invalid' : '' }}"
                                    multiple accept="audio/*" id="audio_files">

                                <div class="text-center">
                                    <div id="title_preview" class="note"></div>
                                    <div class="d-flex flex-wrap justify-content-center align-items-center"
                                        id="preview_multi_tracks">
                                    </div>
                                </div>
                            </div>
                                ...
                                @forelse($albums as $album)
                                    <tr>
                                        @if ($album->audio_file)
                                            @if ($album->img_file)
                                                <td>
                                                    <img class="img-fluid-album-audio-main-image"
                                                        src="{{ asset($album->img_file) }}" alt="">
                                                </td>
                                            @else
                                                <td>
                                                    <img class="img-fluid-album-audio-main-image"
                                                        src="{{ asset('img/img-admin/no_image.jpg') }}" alt="">
                                                </td>
                                            @endif
                                            ...
                                            <td>
                                                @include('admin.pages.music-player.audio-player', [
                                                    'album_tracks' => MusicTracksHelpers::all_tracks_album(
                                                        $album->album_name),
                                                ])
                                            </td>
                                        @endif
        ...
        <form title="Delete this Product" id="form_delete_entry" action="{{ route('track.delete') }}" method="POST">
            ...
            <!-- INPUT HIDDEN -->
            <input type="hidden" id="album_name" name="album_name">
            <!-- INPUT HIDDEN -->
        </form>
        <!-- Delete Multiple Product-->
    </main>
