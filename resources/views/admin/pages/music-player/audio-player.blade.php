        ...
        <div class="row div-album-track mb-4 mx-3 align-items-center music-tracks-page">
            ...
            <div class="col-6">
                ...
                <div class="flex-complete">
                    ...
                    <input type="text" class="form-control input-order-music-tracks position-track" name="position[]"
                        step="1" min="1" value="{{ $track->position }}">
                    <div>
            ...
            <div class="col-6">
                ...
                <div>
                    <div class="mb-2 mt-2">
                        <span
                            class="btn btn-danger delete-button_{{ $track->id }} d-none delete-sweet-alert-music-tracks">
