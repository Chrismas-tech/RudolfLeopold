<section class="oneMusic-buy-now-area has-fluid bg-gray section-padding-100" id="biography">
    <div class="container-fluid">
        ...
        <!-- ENGLISH-->
        <div class="">
            <img class="img-bio p-4" style="float:left;" src="{{asset('img/img-template/rudolf-leopold/rudolf-leopold-2.jpg')}}" alt="">
            <div class="text">
        ...
        <div class="">
            <img class="img-bio p-4" style="float:right;" src="{{asset('img/img-template/rudolf-leopold/rudolf-leopold-3.jpg')}}" alt="">
            <div class="text">
        ...
        <div class="row">
            <div class="col-12 col-md-4">
                <img class="pl-3" style="float:right;max-width:40%;height:auto" src="{{asset('img/img-template/rudolf-leopold/rudolf-leopold-2.jpg')}}" alt="">
            </div>
