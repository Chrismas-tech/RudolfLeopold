                            ...
                            t.exports = function() {
                                var t = 1e3,
                                    ...
                                    v = {
                                        ...
                                        p: function(t) { return { M: f, y: c, w: u, d: o, D: d, h: a, m: s, s: i, ms: r, Q: h }[t] || String(t || "").toLowerCase().replace(/s$/, "") },
                                        u: function(t) { return void 0 === t }
                                    },
                                    p = "en",
                                    g = {};
                                g[p] = m;
                                var y = function(t) { return t instanceof O },
                                    Y = function(t, e, n) {
                                        var r;
                                        if (!t) return p;
                                    ...
                                    w = v;
                                w.l = Y, w.i = y, w.w = function(t, e) { return S(t, { locale: e.$L, utc: e.$u, x: e.$x, $offset: e.$offset }) };
                                var O = function() {
                                        function m(t) { this.$L = Y(t.locale, null, !0), this.parse(t) }
                                        var D = m.prototype;
                                        return D.parse = function(t) {
                                        ...
                                        }, D.$utils = function() { return w }, D.isValid = function() { return !(this.$d.toString() === l) }, D.isSame = function(t, e) { var n = S(t); return this.startOf(e) <= n && n <= this.endOf(e) }, D.isAfter = function(t, e) { return S(t) < this.startOf(e) }, D.isBefore = function(t, e) { return this.endOf(e) < S(t) }, D.$g = function(t, e, n) { return w.u(t) ? this[e] : this.set(n, t) }, D.unix = function() { return Math.floor(this.valueOf() / 1e3) }, D.valueOf = function() { return this.$d.getTime() }, D.startOf = function(t, e) {
                                            var n = this,
                                                r = !!w.u(e) || e,
                                                h = w.p(t),
                                        ...
                                        }, D.endOf = function(t) { return this.startOf(t, !1) }, D.$set = function(t, e) {
                                            var n, u = w.p(t),
                                                h = "set" + (this.$u ? "UTC" : ""),
                                        ...
                                        }, D.set = function(t, e) { return this.clone().$set(t, e) }, D.get = function(t) { return this[w.p(t)]() }, D.add = function(r, h) {
                                            var d, l = this;
                                            r = Number(r);
                                            var $ = w.p(h),
                                                M = function(t) { var e = S(l); return w.w(e.date(e.date() + Math.round(t * r)), l) };
                                            ...
                                            return w.w(D, this)
                                        }, D.subtract = function(t, e) { return this.add(-1 * t, e) }, D.format = function(t) {
                                            var e = this,
                                                n = this.$locale();
                                            ...
                                            return r.replace(M, (function(t, e) { return e || $[t] || i.replace(":", "") }))
                                        }, D.utcOffset = function() { return 15 * -Math.round(this.$d.getTimezoneOffset() / 15) }, D.diff = function(r, d, l) {
                                            var $, M = w.p(d),
                                                m = S(r),
                                        ...
                                        }, D.daysInMonth = function() { return this.endOf(f).$D }, D.$locale = function() { return g[this.$L] }, D.locale = function(t, e) {
                                            if (!t) return this.$L;
                                            var n = this.clone(),
                                                r = Y(t, e, !0);
                                            return r && (n.$L = r), n
                                        }, D.clone = function() { return w.w(this.$d, this) }, D.toDate = function() { return new Date(this.valueOf()) }, D.toJSON = function() { return this.isValid() ? this.toISOString() : null }, D.toISOString = function() { return this.$d.toISOString() }, D.toString = function() { return this.$d.toUTCString() }, m
                                    }(),
                                    L = O.prototype;
                        ...
                        n = t((function(t, e) {
                            t.exports = function() {
                                    ...
                                    h = function(t, e) {
                                        ...
                                        if (r) {
                                            for (var i = 1; i <= 24; i += 1)
                                                if (t.indexOf(r(i, 0, e)) > -1) { n = i > 12; break }
                                        } else n = t === (e ? "pm" : "PM");
                                        return n
                                    },
                                    c = {
                                        A: [i, function(t) { this.afternoon = h(t, !1) }],
                                        a: [i, function(t) { this.afternoon = h(t, !0) }],
                                        S: [/\d/, function(t) { this.milliseconds = 100 * +t }],
                                        SS: [n, function(t) { this.milliseconds = 10 * +t }],
                                        ...
                                        MMM: [i, function(t) {
                                            var e = f("months"),
                                                n = (f("monthsShort") || e.map((function(t) { return t.substr(0, 3) }))).indexOf(t) + 1;
                                ...
                                function d(n) {
                                    var r, i;
                                    r = n, i = s && s.formats;
                                    for (var a = (n = r.replace(/(\[[^\]]+])|(LTS?|l{1,4}|L{1,4})/g, (function(e, n, r) { var s = r && r.toUpperCase(); return n || i[r] || t[r] || i[s].replace(/(\[[^\]]+])|(MMMM|MM|DD|dddd)/g, (function(t, e, n) { return e || n.slice(1) })) }))).match(e), o = a.length, u = 0; u < o; u += 1) {
                                        var f = a[u],
                                            h = c[f],
                                            d = h && h[0],
                                            l = h && h[1];
                                    ...
                                    r.parse = function(t) {
                                        ...
                                        if ("string" == typeof o) {
                                            ...
                                            for (var l = o.length, $ = 1; $ <= l; $ += 1) {
                                                ...
                                                if (M.isValid()) { this.$d = M.$d, this.$L = M.$L, this.init(); break }
                                                $ === l && (this.$d = new Date(""))
                                            } else i.call(this, t)
                                    }
                                }
                    ...
                    Promise.all(p).then((n => {
                        ...
                        Array.from(h).forEach((e => {
                            const s = e.cells[t],
                                i = s.hasAttribute("data-content") ? s.getAttribute("data-content") : s.innerText;
                            let a;
                            a = p ? p(i) : "string" == typeof i ? i.replace(/(\$|,|\s|%)/g, "") : i, parseFloat(a) == a ? l[d++] = { value: Number(a), row: e } : r[o++] = { value: "string" == typeof i ? i.toLowerCase() : i, row: e }
            ...
            class o {
                ...
                render(t) {
                    ...
                    if (s.data && r.call(this), this.body = this.dom.tBodies[0], this.head = this.dom.tHead, this.foot = this.dom.tFoot, this.body || (this.body = e("tbody"), this.dom.appendChild(this.body)), this.hasRows = this.body.rows.length > 0, !this.head) {
                        const t = e("thead"),
                            i = e("tr");
                        this.hasRows && (Array.from(this.body.rows[0].cells).forEach((() => { i.appendChild(e("th")) })), t.appendChild(i)), this.head = t, this.dom.insertBefore(this.head, this.body), this.hiddenHeader = s.hiddenHeader
                    }
                ...
                fixColumns() {
                    if ((this.options.scrollY.length || this.options.fixedColumns) && this.activeHeadings && this.activeHeadings.length) {
                        ...
                        if (this.columnWidths = [], this.dom.tHead) {
                            if (this.options.scrollY.length && (s = e("thead"), s.appendChild(e("tr")), s.style.height = "0px", this.headerTable && (this.dom.tHead = this.headerTable.tHead)), this.activeHeadings.forEach((t => { t.style.width = "" })), this.activeHeadings.forEach(((t, i) => {
                            ...
                            })), this.data.forEach((t => { Array.from(t.cells).forEach(((t, e) => { this.columns(t.cellIndex).visible() && (t.style.width = `${a[e]}%`) })) })), this.dom.removeChild(s)
                        }
                    }
                }
                ...
                export (e) {
                    ...
                    let n, h, r, l;
                    if (!t(e)) return !1;
                    const o = { download: !0, skipColumn: [], lineDelimiter: "\n", columnDelimiter: ",", tableName: "myTable", replacer: null, space: 4, ...e };
                    if (o.type) {
                    ...
                    if (i.data.length || t(i.data)) {
                        if ("csv" === i.type) {
                            ...
                            t.length && (i.headings && (s.headings = t[0].split(i.columnDelimiter), t.shift()), t.forEach(((t, e) => {
                                ...
                                a.length && a.forEach((t => { s.data[e].push(t) }))
                            })))
                        } else if ("json" === i.type) {
                            const e = (e => { let s = !1; try { s = JSON.parse(e) } catch (t) { return !1 } return !(null === s || !Array.isArray(s) && !t(s)) && s })(i.data);
                ...
                print() {
                    const t = this.activeHeadings,
                        ...
                        n = e("tbody"),
                        h = e("tr");
                    t.forEach((t => { h.appendChild(e("th", { html: t.textContent })) })), a.appendChild(h), s.forEach((t => {
                        const s = e("tr");
                        Array.from(t.cells).forEach((t => { s.appendChild(e("td", { html: t.textContent })) })), n.appendChild(s)
