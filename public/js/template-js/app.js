...
/***/ "./resources/js/template-js/Ajax.js":
/*!******************************************!*\
  !*** ./resources/js/template-js/Ajax.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
var Ajax = /*#__PURE__*/function () {
  ...
  _createClass(Ajax, [{
    ...
    key: "success_server",
    value: function success_server(data) {
      console.log('AJAX CLASS');
      /*  console.log(data); */
    }
  }, {
    key: "error_server",
    value: function error_server() {
...
/***/ "./resources/js/template-js/Cart.js":
/*!******************************************!*\
  !*** ./resources/js/template-js/Cart.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var _Ajax__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Ajax */ "./resources/js/template-js/Ajax.js");
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var Cart = /*#__PURE__*/function () {
  ...
  _createClass(Cart, [{
    key: "increment",
    value: function increment(target_click, direction) {
      $(document).on('click', target_click, function () {
        var target_class = $(this).parent().parent().find('.input-qty-css');
        var qty = parseInt($(this).parent().parent().find('.input-qty-css').val());
    ...
    key: "decrement",
    value: function decrement(target_click, direction) {
      $(document).on('click', target_click, function () {
        var target_class = $(this).parent().parent().find('.input-qty-css');
        var qty = parseInt($(this).parent().parent().find('.input-qty-css').val());
...
var Incr_decr_qty = new Cart();
Incr_decr_qty.increment('.bi-plus-square', '+');
Incr_decr_qty.decrement('.bi-file-minus', '-');

/***/ }),

/***/ "./resources/js/template-js/ProductDetailsQuantity.js":
/*!************************************************************!*\
  !*** ./resources/js/template-js/ProductDetailsQuantity.js ***!
  \************************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "ProductDetailsQuantity": () => (/* binding */ ProductDetailsQuantity)
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var ProductDetailsQuantity = /*#__PURE__*/function () {
  function ProductDetailsQuantity(target_click, target_class, direction) {
    _classCallCheck(this, ProductDetailsQuantity);
  ...
  _createClass(ProductDetailsQuantity, [{
    key: "incr_decr",
    value: function incr_decr(target_click, target_class, direction) {
      $(document).on('click', target_click, function () {
        var qty = parseInt($(target_class).val());
...
/***/ "./resources/js/template-js/SearchbarAjax.js":
/*!***************************************************!*\
  !*** ./resources/js/template-js/SearchbarAjax.js ***!
  \***************************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "SearchbarAjax": () => (/* binding */ SearchbarAjax)
/* harmony export */ });
function _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError("Cannot call a class as a function"); } }
...
var SearchbarAjax = /*#__PURE__*/function () {
  function SearchbarAjax(url, input_searchbar) {
    var spinner_class = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
    var search_result_id = arguments.length > 3 ? arguments[3] : undefined;
    var form_searchbar_id = arguments.length > 4 ? arguments[4] : undefined;
    var setTimeout = arguments.length > 5 ? arguments[5] : undefined;

    _classCallCheck(this, SearchbarAjax);
    ...
    this.timer; // Keyup into Ajax

    this.keyup(); // Click outside Hide Searchbar

    this.Hide_searchbar_click_outside();
  }

  _createClass(SearchbarAjax, [{
    key: "keyup",
    value: function keyup() {
      var this_instance = this;
      $(input_searchbar).keyup({
        this_instance: this_instance
      }, function () {
        this_instance.clearTimer(this_instance.timer);
        var q = $(this).val(); // If Research length > 2

        if (q.length > 1) {
          // Show spinner
          $(this_instance.spinner_class).show(); // After 600ms => Request Ajax

          this_instance.timer = setTimeout(function () {
            this_instance.ajax_call(this_instance.url, 'POST', {
              q: q
            });
    ...
    key: "ajax_call",
    value: function ajax_call(url, type, data) {
      var this_instance = this;
      $.ajaxSetup({
        headers: {
          'X-CSRF-TOKEN': $('meta[name="_token"]').attr('content')
      ...
      $.post({
        ...
        data: data,
        success: function success(data) {
          this_instance.success_response(data, this_instance.search_result_id, this_instance.spinner_class);
        }
      }, this_instance);
    }
  }, {
    key: "Hide_searchbar_click_outside",
    value: function Hide_searchbar_click_outside() {
      var this_instance = this; // Click outside of searchbar
    ...
    value: function success_response(data, search_result_id, spinner_class) {
  ...
  return SearchbarAjax;
}(); // Start Searchbar

var SearchbarHome = new SearchbarAjax('ajax-searchbar', '#input_searchbar', '.spinner-border', '#searchbar_results', '#form-searchbar', 600);

/***/ }),

/***/ "./resources/js/template-js/ajax-add-cart.js":
/*!***************************************************!*\
  !*** ./resources/js/template-js/ajax-add-cart.js ***!
  \***************************************************/
/***/ (() => {
...
$(function () {
  $(document).on('click', '#add-to-cart', function (e) {
    ...
    var qty = $('[name="product_details_qty"]').val();
    console.log(qty);
...
/***/ "./resources/js/template-js/ajax-option-product.js":
/*!*********************************************************!*\
  !*** ./resources/js/template-js/ajax-option-product.js ***!
  \*********************************************************/
/***/ (() => {
...
$(function () {
  ...
  var input_values = [];
  input_radio_values.each(function (index, value) {
    input_values.push($(value).attr('id'));
  });
  old_input_values = input_values;
  ajax_call(input_values, id); // Update Ajax Main and Multi Images
  ...
  $.ajax({
    ...
    success: function success(data) {
      ...
      if (data.message == true) {
        var price = data.product.unit_price / 100;
        var qty = data.product.qty;
        var preview_images_front = data.multi_images_variant;
        var variant_id = data.product.id;
...
function regenerate_preview_images(array_imgs_server) {
  ...
  array_imgs_server.forEach(function (el) {
    $('.product-details-previews-imgs').append("<div class=\"me-1\">\n            <img class=\"product-details-preview-img\" src=\"" + el + "\" data-zoom=" + el + " alt=\"\">\n        </div>");
  });
}
...
/***/ "./resources/js/template-js/my-megamenu-click-category.js.js":
/*!*******************************************************************!*\
  !*** ./resources/js/template-js/my-megamenu-click-category.js.js ***!
  \*******************************************************************/
/***/ (() => {
...
/***/ "./resources/js/template-js/my-product-details-switch-img-variant.js":
/*!***************************************************************************!*\
  !*** ./resources/js/template-js/my-product-details-switch-img-variant.js ***!
  \***************************************************************************/
/***/ (() => {
...
window.Drift = drift_zoom__WEBPACK_IMPORTED_MODULE_1__["default"]; // SweetAlert2


window.Swal = (sweetalert2__WEBPACK_IMPORTED_MODULE_2___default()); // Ajax 

__webpack_require__(/*! ./Ajax */ "./resources/js/template-js/Ajax.js");

__webpack_require__(/*! ./SearchbarAjax */ "./resources/js/template-js/SearchbarAjax.js");
/*  require('./testAjaxExtends') */

/* require('./testSearchbar') */


__webpack_require__(/*! ./ajax-add-cart */ "./resources/js/template-js/ajax-add-cart.js");

__webpack_require__(/*! ./ajax-option-product */ "./resources/js/template-js/ajax-option-product.js");

__webpack_require__(/*! ./Cart */ "./resources/js/template-js/Cart.js");

__webpack_require__(/*! ./my-megamenu-click-category.js */ "./resources/js/template-js/my-megamenu-click-category.js.js");

__webpack_require__(/*! ./my-product-details-switch-img-variant */ "./resources/js/template-js/my-product-details-switch-img-variant.js");

__webpack_require__(/*! ./ProductDetailsQuantity */ "./resources/js/template-js/ProductDetailsQuantity.js");
})();
